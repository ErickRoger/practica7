...
<body id="main_body" >
	<img src="css/ER.gif" width="700" height="150" />
	...
	<div id="form_container">
		...
		<div>
			<input id="Apellidos" name="Apellidos" class="element text medium" type="text" maxlength="255" value="" required /> 
		</div> 
		</li>		
		<li id="li_3" >
...
if (empty($_POST['pass']) || empty($_POST['Apellidos'])) {
$error = "Username or Password is invalid";
}
else
{
// Define $username and $password
$username=$_POST['Apellidos'];
$password=$_POST['pass'];
...
$query = $con->query("select * from personal where password='$password' AND Apellidos='$username'");
$rows = $query->num_rows;
if ($rows == 1) {
$r=$query->fetch_array();
$nom = $r['nombre'];
